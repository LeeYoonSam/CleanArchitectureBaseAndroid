...
import com.ys.base.core.common.network.mapper.ApiErrorModelMapper
import com.ys.base.core.common.network.mapper.ApiResponseMapper
import com.ys.base.core.common.network.mapper.ApiSuccessModelMapper
...
public inline fun <reified T, reified V> ApiResponse<T>.mapSuccess(
    ...
    if (this is ApiResponse.Success<T>) {
        return ApiResponse.of { transformer(data) }
    }
...
public fun <T> ApiResponse<List<T>>.merge(
    ...
    var apiResponse: ApiResponse<List<T>> = ApiResponse.of { mutableListOf() }
    ...
    for (response in apiResponses) {
        if (response is ApiResponse.Success) {
            ...
            apiResponse = ApiResponse.Success(data = data)
